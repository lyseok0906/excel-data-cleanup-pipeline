...
On the tested machine, `UNICODE(UNICHAR(160))` returned 160 while `UNICODE(CHAR(160))` returned 32. That is why this article uses `UNICHAR(160)` for the NBSP replacement.
